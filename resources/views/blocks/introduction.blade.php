<div {!! soreau_block_wrapper( $block, $attributes, 'soreau-introduction', [], ['data-block-name' => $block->name ?? null] ) !!}>
  <div class="grid grid-cols-1 grid-rows-2 md:grid-cols-2 md:grid-rows-1 gap-5 1920:gap-7.5 mt-10 1440:mt-15 1920:mt-20">
    <div>
    ...
    <div class="md:row-start-auto row-start-2 self-center flex flex-col items-center justify-start w-full border border-dark-12 1440:rounded-(--radius-20) rounded-2xl 1920:p-10 1440:p-7.5 p-6">
      {!! $content !!}
    </div>
  </div>
</div>
